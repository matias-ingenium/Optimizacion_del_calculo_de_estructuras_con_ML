...
def generate_test_data(n_test_snapshots, mesh_file, facet_file, physical_file):
    ...
    test_data_file = f"generando_matriz_inversa/elementos de prueba/datos_testeo_{n_test_snapshots}.pkl"
    ...
    if os.path.exists(test_data_file):
        ...
        test_set_params = [tuple(random.uniform(-1, 1) for _ in range(12)) for _ in range(n_test_snapshots)]
