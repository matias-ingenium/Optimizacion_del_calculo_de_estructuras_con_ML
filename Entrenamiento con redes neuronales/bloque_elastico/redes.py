...
class RED_NEURONAL:
    ...
    def entrenar(self):
        ...
        epochs_no_improve = 0
        scheduler = ReduceLROnPlateau(self.optimizer, mode='min', factor=0.5, patience=500, verbose=True)
        for epoch in range(self.max_epochs):
            ...
            if epoch % 200 == 0:
                print(f"Época {epoch}, Pérdida: {loss.item():.8f}, lr: {self.optimizer.param_groups[0]['lr']}")
